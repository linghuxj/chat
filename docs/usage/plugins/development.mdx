...
│   │   └── page.tsx                # Front-end display interface
```
...
In the template we provide, we use React + Next.js + [antd](https://ant.design/) as the frontend interface framework. You can find the implementation of the user interface in [`src/pages/page.tsx`](https://github.com/lobehub/chat-plugin-template/blob/main/src/pages/page.tsx).
