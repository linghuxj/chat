...
在我们提供的模板中使用了 React + Next.js + [antd](https://ant.design/) 作为前端界面框架，你可以在 [`src/pages/page.tsx`](https://github.com/lobehub/chat-plugin-template/blob/main/src/pages/page.tsx) 中找到用户界面的实现。
